...
public class OpponentReactions : MonoBehaviour
{
    ...
    public void react_to_move(Move playerMove, string opponentMove)
    {
        ...
        /*ALL THAT IS NEEDED TO BE ADDED HERE IS TO CALL minusHealth for every possible combination of playerMove and opponentMove
         * Default values:
         * Super effective - 15 dmg
         * Semi-effective - 10 dmg
         * Not very effective - 5 dmg
         */
    ...
    public void minusHealth()
    {
        ...
        healthBar.valueText.text = health.value.ToString() + "/" + health.maxValue.ToString();
    }
